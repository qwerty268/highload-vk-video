...
<table >
    ...
    <tr>
        <td>Видео</td>
        <td>Средний размер видео: 22.5 МБ (шортс) и 500 МБ (длинные).  
           ...
           => из 14.8 млрд видео * 0.1 = 1.48 млрд в год. Из шортс и обычные видео относятся как 80:20. 1.48 * 10^9 * 0.8 * 22.5 = 2.7 * 10^10 МБ на шортс = <b>24 405 Петобайт</b> </td>
    </tr>
    <tr>
        <td>Трансляции</td>
