...
<table >
    ...
    <tr>
        <td>Пользователи</td>
        <td>На одного пользователя необходимо (25,8 + 32) = 57,8 МБ, тогда на 76 млн пользователей потребуется <b>4188 ТБ</b></td>
    </tr>
    <tr>
        <td>Видео</td>
        <td>Средний размер видео: 50 МБ (шортс) и 500 МБ (длинные).  
            Всего 76 млн пользователей смотрят 38 шортс и 2 длинных видео в день,  
            тогда суммарно в день загружается ~3,04 млрд видео.  
            Если хранить историю за 1 месяц, понадобится <b>153 600 ТБ</b></td>
    </tr>
    <tr>
        <td>Трансляции</td>
        <td>Средний размер трансляции 2 ГБ. В день 3,04 млн трансляций,  
            тогда за месяц потребуется <b>182 400 ТБ</b></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>Средний пользователь смотрит 40 минут видео в день,  
            запрос на новый фрагмент каждые 5 секунд,  
            RPS = 76 млн * 40 * 12 / 86400 = <b>422 000</b></td>
        <td>В пике 10 млн пользователей одновременно,  
            RPS = 10 000 000 / 5 = <b>2 000 000</b></td>
    </tr>
    <tr>
        <td>Авторизация/регистрация</td>
        <td>-</td>
        <td>-</td>
        <td><b>76 млн</b></td>
        <td><b>5 млн (в пиковые часы)</b></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Добавление в "Сохраненные"</td>
        <td>-</td>
        <td>-</td>
        <td>76 млн * 0,05 = <b>3,8 млн</b></td>
        <td><b>500 тыс</b></td>
    </tr>
    <tr>
        <td>Поиск видео</td>
    ...
    <tr>
        <td>Просмотр трансляций</td>
        <td>Средняя трансляция 2 ГБ, 3,04 млн в день,  
            <b>10 000 Гбит/с</b> пиковая нагрузка</td>
        <td>3,04 млн * 2 ГБ = <b>6 080 ГБ</b></td>
        <td>Средняя длительность 1 час, новый фрагмент каждые 5 секунд,  
            RPS = 3,04 млн * 60 * 12 / 86400 = <b>25 000</b></td>
        <td>В пике 500 000 зрителей, RPS = <b>100 000</b></td>
    </tr>
</table>
